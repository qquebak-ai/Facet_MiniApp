...
async function нарисовать(строки) {
  ...
  ${[
    // Листопад в правом углу шапки: размеры и наклоны разные, ближние
    // ярче и крупнее — иначе десяток одинаковых листьев читается узором
    // из обоев, а не падающей листвой. Левее 700 не заходим: там текст.
    [742, 78, -34, 44, Ц.акцент, 0.34],
    [884, 116, -20, 66, Ц.акцент, 0.6],
    [1006, 74, 28, 40, Ц.светлый, 0.3],
    [962, 186, 12, 52, Ц.светлый, 0.45],
    [1042, 268, -14, 46, Ц.акцент, 0.4],
    [886, 274, 40, 34, Ц.светлый, 0.28],
    [806, 214, -6, 38, Ц.акцент, 0.3],
    [744, 336, 18, 50, Ц.акцент, 0.42],
    [928, 388, -28, 42, Ц.светлый, 0.32],
    [1032, 402, 8, 36, Ц.акцент, 0.26],
    [852, 168, 62, 28, Ц.светлый, 0.22],
  ].map((л) => веточка(...л)).join("\n  ")}
