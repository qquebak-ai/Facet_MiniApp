...
export default defineConfig({
  ...
  // Имя латиницей намеренно: значения define сборщик подставляет разбором
  // имени как идентификатора, и на кириллице это зависит от его версии —
  // локально проходило, а сборка на сервере падала молча.
  define: {
