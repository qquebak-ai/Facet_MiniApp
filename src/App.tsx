...
function WidgetSparks({ seed = 4242 }) {
  const items = useMemo(() => {
...
function HomeHero({ onGoTab }) {
  const sparkSeed = useMemo(() => 1 + Math.floor(Math.random() * 99999), []);
  const actions = [
            ...
            >
              <div
                ...
                style={{
                  ...
                  background: isLaunch ? "#000000" : T.surface, border: `1px solid ${T.line}`,
                  display: "flex", alignItems: "center", justifyContent: "center",
                  position: "relative", overflow: "hidden",
                }}
              >
                <WidgetSparks seed={sparkSeed} />
                {isLaunch ? (
                  <RocketIconFX />
                ) : (
