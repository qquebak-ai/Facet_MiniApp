...
function ImageCropModal({ file, shape = "circle", onCancel, onConfirm }) {
  ...
  return (
    <div className="fx-modal-back" style={{ position: "absolute", inset: 0, zIndex: 90, background: "rgba(2,2,4,0.9)", backdropFilter: "blur(6px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }} onClick={(e) => { e.stopPropagation(); onCancel(); }}>
