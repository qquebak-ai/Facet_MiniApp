  ...
  return (
    <style>{`
      ...
      * { -webkit-tap-highlight-color: transparent; }
      ...
      @keyframes mempadFlameFlicker { 0%{ transform: scaleY(1) scaleX(1) rotate(0deg); opacity:0.85; } 25%{ transform: scaleY(1.08) scaleX(0.94) rotate(-2deg); opacity:1; } 50%{ transform: scaleY(0.94) scaleX(1.04) rotate(1deg); opacity:0.9; } 75%{ transform: scaleY(1.1) scaleX(0.96) rotate(-1deg); opacity:1; } 100%{ transform: scaleY(1) scaleX(1) rotate(0deg); opacity:0.85; } }
...
/* MempadFlameFX — the "Мемпад" icon: same Flame glyph, but flickering
   like a real fire (subtle scale/rotation wobble on a loop). */
function MempadFlameFX() {
  return (
    <div style={{ position: "relative", width: 34, height: 34, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <Flame
        size={27}
        strokeWidth={1.6}
        color={T.electric}
        style={{ position: "relative", animation: "mempadFlameFlicker 1.1s ease-in-out infinite", transformOrigin: "50% 90%" }}
      />
    </div>
  );
}
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2.5">
        {actions.map(a => {
          ...
          const isMempad = a.key === "homeActionMempad";
          const isDark = isLaunch || isMempad;
          return (
            <button
              key={a.key}
              onClick={a.onClick}
              className="fx-tap fx-card flex-1 flex flex-col items-start gap-4 rounded-[20px] p-4"
              style={{ background: isDark ? "#000000" : T.surface, border: `1px solid ${T.line}`, position: "relative", overflow: "hidden" }}
            >
  ...
  return (
    <div style={{ background: T.bg, height, minHeight: height, width: "100%", maxWidth: 480, margin: "0 auto", fontFamily: bodyFont, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div className="no-scrollbar px-4" style={{ flex: 1, overflowY: "auto", minHeight: 0, paddingTop: insetTop + 56, paddingBottom: 100 + insetBottom }} key={view}>
        ...
        <div
          ...
          style={{
            ...
            background: hexA(T.bg, 0.18), backdropFilter: "blur(20px) saturate(1.6)", WebkitBackdropFilter: "blur(20px) saturate(1.6)",
          }}
        >
          {[
