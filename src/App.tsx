...
const FACET_CLIP = "polygon(18% 0%, 100% 0%, 100% 82%, 82% 100%, 0% 100%, 0% 18%)";
...
function MintlyFrame({ children, size = 52, glow }) {
  return (
    <div style={{
      width: size, height: size, clipPath: FACET_CLIP, background: T.surfaceHi, border: `1px solid ${T.line}`,
    ...
    <div className="fx-modal-back" style={{ position: "absolute", inset: 0, zIndex: 80, background: "rgba(2,2,4,0.92)", backdropFilter: "blur(6px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      {error ? (
        <div className="fx-modal-card flex flex-col items-center text-center gap-4" style={{ width: "100%", maxWidth: 340, background: T.surface, border: `1px solid ${T.lineHi}`, borderRadius: 24, padding: 24 }}>
          <div style={{ width: 64, height: 64, clipPath: FACET_CLIP, background: hexA(T.down, 0.12), border: `1px solid ${hexA(T.down, 0.35)}`, display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div className="fx-modal-card flex flex-col items-center text-center gap-5" style={{ width: "100%", maxWidth: 340 }}>
          <div style={{ width: 64, height: 64, clipPath: FACET_CLIP, background: T.surfaceHi, border: `1px solid ${T.lineHi}`, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: `0 0 26px ${glow(0.3)}` }}>
            ...
            <div className="flex flex-col gap-2">
              {[0, 1].map(i => (
                <div key={i} className="fx-card flex items-center gap-3 rounded-2xl" style={{ background: T.surface, border: `1px solid ${T.line}`, padding: "12px 14px" }}>
                  <div className="fx-skeleton" style={{ width: 52, height: 52, clipPath: FACET_CLIP }} />
                  <div className="flex-1 flex flex-col gap-2">
