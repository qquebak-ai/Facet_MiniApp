...
function MempadRow({ t: tok, onOpen, index }) {
  return (
    <button onClick={() => onOpen(tok)} className="fx-tap w-full flex items-center gap-3 py-3 text-left" style={{ borderBottom: `1px solid ${T.line}`, animationDelay: `${index * 55}ms` }}>
...
function MempadRowSkeleton({ index }) {
  return (
    <div className="w-full flex items-center gap-3 py-3" style={{ borderBottom: `1px solid ${T.line}`, animationDelay: `${index * 55}ms` }}>
      ...
      {loading && !spotlight ? (
        ...
        <div>
          ...
          <button onClick={() => onOpen(spotlight)} className="fx-card w-full flex flex-col items-center text-center gap-2.5 rounded-[22px] p-6" style={{ background: T.surface, border: `1px solid ${T.line}`, position: "relative", overflow: "hidden" }}>
            <SpotlightFX up={spotlight.change >= 0} seedKey={spotlight.seed} />
    ...
    <div style={{ background: T.bg, height, minHeight: height, width: "100%", maxWidth: 480, margin: "0 auto", fontFamily: bodyFont, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div className="no-scrollbar px-4" style={{ flex: 1, overflowY: "auto", minHeight: 0, paddingTop: 64 }} key={view}>
          ...
          {view === "mempad" && <MempadView tokens={tokens} loading={tokensLoading} myTokens={myTokens} onOpen={openToken} onLaunch={() => goTab("create")} />}
