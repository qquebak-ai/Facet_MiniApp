...
const LEAF_KINDS = [
  // клён
  {
    // Край зубчатый, а не гладкий: у настоящего клёна между лопастями
    // идут зубцы. Зубцы посчитаны по гладкому контуру — равномерно по
    // длине края и с затуханием у самых острых мест, чтобы не срезать
    // кончики лопастей.
    outline: "M 0.0 -1.0 L 1.7 -2.3 L 3.8 -2.7 L 5.6 -4.2 L 8.6 -3.8 L 9.7 -5.9 L 9.5 -6.1 L 6.8 -7.9 L 5.2 -9.4 L 7.3 -9.9 L 10.8 -10.0 L 11.4 -11.5 L 13.7 -12.4 L 12.2 -13.2 L 11.6 -13.6 L 8.0 -14.4 L 6.7 -15.3 L 5.9 -16.5 L 8.9 -18.5 L 9.0 -19.6 L 10.6 -21.5 L 9.0 -22.0 L 7.9 -23.5 L 4.7 -23.0 L 3.5 -25.0 L 2.4 -26.3 L 1.4 -29.7 L 0.0 -30.0 L -1.4 -29.7 L -2.4 -26.3 L -3.5 -25.0 L -4.7 -23.0 L -7.9 -23.5 L -9.0 -22.0 L -10.6 -21.5 L -9.0 -19.6 L -8.9 -18.5 L -5.9 -16.5 L -6.7 -15.3 L -8.0 -14.4 L -11.6 -13.6 L -12.2 -13.2 L -13.7 -12.4 L -11.4 -11.5 L -10.8 -10.0 L -7.3 -9.9 L -5.2 -9.4 L -6.8 -7.9 L -9.5 -6.1 L -9.7 -5.9 L -8.6 -3.8 L -5.6 -4.2 L -3.8 -2.7 L -1.7 -2.3 Z",
    stem: "M 0 -1 Q 0.4 1.6 0.2 4.6",
    // Пять главных жилок расходятся из черешка, и ни одна не идёт по
    // линейке: каждая выгнута наружу, к своей лопасти. От средней жилки
    // ещё отходят короткие боковые — без них лист читался как звёздочка
    // из палок.
    veins: [
      "M 0.0 -1.2 Q 0.9 -13.5 0.0 -26.2",
      "M 0.0 -1.2 Q 4.8 -2.4 9.7 -6.0",
      "M 0.0 -1.2 Q -4.8 -2.4 -9.7 -6.0",
      "M 0.0 -1.2 Q 6.6 -6.0 12.7 -12.2",
      "M 0.0 -1.2 Q -6.6 -6.0 -12.7 -12.2",
      "M 0.0 -1.2 Q 3.2 -11.8 9.4 -20.8",
      "M 0.0 -1.2 Q -3.2 -11.8 -9.4 -20.8",
      "M 0.4 -9.0 Q 2.4 -10.4 4.6 -13.4",
      "M -0.4 -9.0 Q -2.4 -10.4 -4.6 -13.4",
      "M 0.5 -15.4 Q 2.2 -16.6 3.8 -19.6",
      "M -0.5 -15.4 Q -2.2 -16.6 -3.8 -19.6",
    ],
  },
  // дуб
