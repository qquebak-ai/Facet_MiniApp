  ...
  return (
    <div style={{ background: T.bg, height, minHeight: height, width: "100%", maxWidth: 480, margin: "0 auto", fontFamily: bodyFont, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, height: "100%", display: "flex", flexDirection: "column" }}>
        <div
          className="glass-widget flex items-center justify-between px-4 pt-4 pb-3"
          style={{
            flexShrink: 0,
            background: `linear-gradient(180deg, ${ink(0.10)}, ${ink(0.03)})`,
            borderBottom: `1px solid ${ink(0.22)}`,
            boxShadow: `inset 0 -1px 0 ${ink(0.10)}, 0 8px 24px -12px rgba(0,0,0,0.4)`,
          }}
        >
          <button onClick={() => goTab("home")} className="fx-tap flex items-center gap-1.5" style={{ position: "relative", zIndex: 1 }}>
          ...
          <button onClick={handleHeaderWalletClick} className="fx-tap fx-chip flex items-center gap-1.5 rounded-full px-3 py-1.5" style={{ position: "relative", zIndex: 1, background: ink(0.08), border: `1px solid ${connected ? glow(0.35) : ink(0.25)}` }}>
        ...
        <div className="glass-widget flex items-center justify-around px-2 py-4" style={{ borderTop: `1px solid ${ink(0.22)}`, background: `linear-gradient(0deg, ${ink(0.10)}, ${ink(0.03)})`, flexShrink: 0, paddingBottom: insetBottom + 16 }}>
          {[
