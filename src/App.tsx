...
function TokenAvatar({ children, size = 52, tone = "neutral", src }) {
  ...
  return (
    <div className="fx-avatar" style={{ width: size, height: size, position: "relative", flexShrink: 0 }}>
      ...
      <div style={{
        position: "absolute", inset: 1.5, borderRadius: "50%", background: T.surfaceHi,
...
function SectionTitle({ children, action }) {
  return (
    <div className="flex items-center justify-between mb-2.5">
      <span style={{ fontFamily: displayFont, color: T.ice, fontSize: 22, fontWeight: 600, fontStyle: "italic", letterSpacing: "-0.005em" }}>{children}</span>
      {action}
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="relative pt-2 pb-1">
        <div className="relative" style={{ fontFamily: displayFont, color: T.ice, fontSize: 40, fontWeight: 600, fontStyle: "italic", lineHeight: 1.08, letterSpacing: "-0.01em" }}>
          {t("heroTitle")}
        </div>
  ...
  return (
    <div className="flex flex-col gap-5" style={{ paddingBottom: 12 }}>
      <div className="flex items-center justify-between">
        <span style={{ fontFamily: displayFont, color: T.ice, fontSize: 34, fontWeight: 600, fontStyle: "italic", letterSpacing: "-0.01em" }}>{t("navMempad")}</span>
    ...
    <div className="fx-view flex flex-col gap-7 pb-36" style={{ position: "relative" }}>
      ...
      <div>
        ...
        <div className="flex gap-3 mt-1.5">
          ...
          <button onClick={() => bannerInputRef.current && bannerInputRef.current.click()} className="fx-tap flex-1 flex flex-col items-center justify-center gap-1 rounded-[22px] overflow-hidden" style={{ background: bannerUrl ? `center/cover no-repeat url(${bannerUrl})` : T.surface, border: `1px dashed ${T.line}` }}>
...
function MyTokenCard({ t, onManage }) {
  return (
    <GlassCard style={{ padding: "12px 14px" }} className="flex items-center gap-3">
      ...
      <button onClick={() => onManage && onManage(t)} className="fx-tap rounded-[16px] px-3 py-1.5" style={{ background: T.surfaceHi, border: `1px solid ${T.line}`, fontFamily: bodyFont, fontSize: 11, color: T.ice }}>Manage</button>
    </GlassCard>
  );
}
        ...
        <div className="flex flex-col items-center text-center gap-2" style={{ marginTop: 10, position: "relative" }}>
          ...
          {accountCreated ? (
            <>
              ...
              <button onClick={onOpenEditProfile} className="fx-tap rounded-[20px] px-5 py-2.5 mt-2" style={{ background: T.surface, border: `1px solid ${T.line}`, fontFamily: bodyFont, fontSize: 13, color: T.ice }}>Edit Profile</button>
            </>
          ) : (
            <>
        ...
        <div className="mt-5">
          ...
          {!connected ? (
            <GlassCard style={{ padding: 22 }} className="flex flex-col items-center text-center gap-3">
              ...
              <button onClick={connectWallet} className="fx-tap rounded-[20px] px-5 py-2.5" style={{ background: PRISM, color: PRISM_TEXT, fontFamily: displayFont, fontWeight: 700, fontSize: 13 }}>Connect Wallet</button>
            </GlassCard>
          ) : loading ? (
            <div className="flex flex-col gap-2">
              {[0, 1].map(i => (
    ...
    <div style={{ background: T.bg, height, minHeight: height, width: "100%", maxWidth: 480, margin: "0 auto", fontFamily: bodyFont, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, height: "100%", display: "flex", flexDirection: "column" }}>
        <div className="flex items-center justify-between px-4 pt-4 pb-2" style={{ flexShrink: 0 }}>
          ...
          <span style={{ fontFamily: displayFont, color: T.ice, fontSize: 26, fontWeight: 600, fontStyle: "italic", letterSpacing: "0em" }}>Mintly</span>
          </button>
        ...
        <div className="flex items-center justify-around px-2 py-4" style={{ borderTop: `1px solid ${T.line}`, background: T.bg, flexShrink: 0, paddingBottom: insetBottom + 16 }}>
          {[
