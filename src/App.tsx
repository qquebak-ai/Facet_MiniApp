...
function TerminalChart({ candles, height = 340, themeKey, onHover, tf }) {
  ...
  function computeLayout() {
    ...
    return { startI, endI, min, max, range, slot, bodyW, yFor, xFor, padTop, padBottom, drawHeight };
  }
  ...
  return (
    <div ref={wrapRef} style={{ width: "100%", height, position: "relative", touchAction: "none" }}
      ...
      {/* Price-scale handle: the visible grip pill, drag it up/down. */}
      <div
        ...
        style={{ position: "absolute", right: 0, top: 0, width: 28, height: "100%", touchAction: "none", cursor: "ns-resize" }}
      >
        <div style={{
          position: "absolute", top: "50%", right: 3, transform: "translateY(-50%)",
          width: 20, height: 38, borderRadius: 9, display: "flex", flexDirection: "column",
          alignItems: "center", justifyContent: "center", gap: 3,
          background: hexA(T.ice, 0.12), border: `1px solid ${hexA(T.ice, 0.22)}`, backdropFilter: "blur(4px)",
        }}>
          <span style={{ width: 11, height: 1.5, borderRadius: 1, background: T.muted }} />
          <span style={{ width: 11, height: 1.5, borderRadius: 1, background: T.muted }} />
          <span style={{ width: 11, height: 1.5, borderRadius: 1, background: T.muted }} />
        </div>
      </div>
