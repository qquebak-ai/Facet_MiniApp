...
const CandlestickChart = React.memo(function CandlestickChart({ data, width = 340, height = 170 }) {
  ...
  return (
    <svg width="100%" height={height} viewBox={`0 0 ${width} ${height}`} style={{ display: "block", overflow: "visible" }}>
      ...
      {data.map((c, i) => {
        ...
        return (
          <g key={c.i} style={isNew ? { transformOrigin: `${x}px ${height - padB}px`, animation: `candleGrow 420ms cubic-bezier(0.16,1,0.3,1) both`, animationDelay: `${i * 8}ms` } : undefined}>
