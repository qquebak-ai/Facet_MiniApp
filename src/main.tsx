...
if (tg) {
  ...
  // Просим целую страницу — метод появился в Bot API 8.0, в старых
  // клиентах остаётся прежнее раскрытие на всю высоту.
  try { (tg as any).requestFullscreen?.(); } catch { /* старый клиент */ }
