...
export async function launchRealToken({
  ...
  // FIX: Tonhub's HTTP v4 API calls its test network "sandbox", not
  // "testnet" — https://testnet-v4.tonhubapi.com does not exist, and
  // every request to it just times out. That's what was surfacing as
  // "Exceeded number of retries" during launch. The correct host is
  // sandbox-v4.tonhubapi.com (confirmed against Tonhub's own docs and
  // the ton-community/ton-api-v4 repo). Mainnet host is unchanged.
