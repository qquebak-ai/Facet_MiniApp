...
import {
  ...
  Eye, EyeOff, LogIn, Mail, KeyRound, ShoppingBag
} from "lucide-react";
  ...
  return (
    <div style={{ background: T.bg, height, minHeight: height, width: "100%", maxWidth: 480, margin: "0 auto", fontFamily: bodyFont, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div className="no-scrollbar px-4" style={{ flex: 1, overflowY: "auto", minHeight: 0, paddingTop: 16 }} key={view}>
        ...
        <div
          className="flex items-center justify-around px-2 pt-4"
          style={{
            borderTop: `1px solid ${T.line}`, flexShrink: 0, paddingBottom: insetBottom + 16,
