...
export function ЗнакPhantom({ размер = 16 }) {
  return (
    <svg width={размер} height={размер} viewBox="0 0 24 24" aria-hidden focusable="false">
      ...
      <path
        d="M18.6 11.9c0-3.5-2.8-6.3-6.3-6.3-3.4 0-6.2 2.7-6.3 6.1-.1 3 1.5 5.4 1.5 5.4.2.3.7.2.7-.2 0-1.6.9-3 2.2-3.6-.2.5-.3 1-.3 1.5 0 .5.4.9.9.9s.9-.4.9-.9c0-1.1.9-2 2-2s2 .9 2 2c0 .5.4.9.9.9s.9-.4.9-.9c0-.3 0-.6-.1-.9h.5c.2 0 .4-.2.4-.4v-1.6z"
        fill="#fff"
      />
    </svg>
  );
